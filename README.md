[tannu_birthday.html](https://github.com/user-attachments/files/28663743/tannu_birthday.html)
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .photo-frame-lg:hover { transform:scale(1.03) rotate(-1deg); }
  .photo-frame-lg img { width:100%; height:100%; object-fit:cover; object-position:top; }
