[index.html](https://github.com/user-attachments/files/28668658/tannu_birthday.5.html)
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
  ...
  function animate() {
    ...
    if(frame < 90) requestAnimationFrame(animate);
      ...
      setTimeout(()=>{
        ...
        document.getElementById('music-btn').style.alignItems='center';
        document.getElementById('music-btn').style.justifyContent='center';
      },800);
    }
  }
  animate();
