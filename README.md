[intex.html](https://github.com/user-attachments/files/28662747/intex.html)
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .photo-frame-lg:hover { transform:scale(1.04) rotate(-1deg); }
  .photo-frame-lg img { width:100%; height:100%; object-fit:cover; }
...
<section class="slide slide-1" id="s0">
  ...
  <div class="bubble" style="width:200px;height:200px;background:#f48fb1;top:-50px;left:-60px;animation-delay:0s;"></div>
  <div class="bubble" style="width:130px;height:130px;background:#f06292;bottom:80px;right:-30px;animation-delay:1.5s;"></div>

  <div class="badge">✨ Special Day ✨</div>
  <div class="photo-frame-lg"><img src="img4.jpg" alt="Tannu"></div>
...
<section class="slide slide-2" id="s1">
  ...
  <div class="slide2-layout">
    ...
    <div class="center-msg" style="margin-top:215px;">
