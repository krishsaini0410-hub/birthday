[tannu_birthday (4).html](https://github.com/user-attachments/files/28668462/tannu_birthday.4.html)
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  @media (max-width: 600px) {
    .slide-1 { flex-direction:column !important; align-items:center !important; }
    .slide1-photo { width:100% !important; min-height:55vh !important; }
    .slide1-photo img { object-position:center top; }
    .slide1-text { padding:24px 20px; width:100%; }

    .slide2-layout { max-width:100%; min-height:auto; padding:10px 0; }
    .corner-photo { width:110px !important; height:135px !important; }
    .corner-tl { top:8px; left:4px; }
    .corner-tr { top:8px; right:4px; }
    .center-msg { margin-top:155px !important; }
    .center-msg .msg-text { font-size:20px; }
    .bottom-photo { width:130px !important; height:130px !important; }

    .horiz-photos { flex-direction:column; align-items:center; }
    .horiz-frame { width:88vw !important; height:210px !important; }

    .slide-title { font-size:clamp(26px,7vw,40px); }
    .slide-sub { font-size:13px; max-width:90vw; }
